...
$(window).on('load', function() {
    ...
    //listamos los datos...
	    ...
	    var t = $('#clientes_data').DataTable({
	        ...
	        "dom": '<"newtoolbar">frtip',
					...
					"ajax":{
						"method":"POST",
						"url": "../php/marca/showData.php"
					},

					"columns":[
						{"data":"nombre_marca"},
						{"data":"nombre_marca_ingles"},
						{"data":"created_marca"},
						{"data":"modified_marca"},											
	...
	var obtener_id_eliminar = function(tbody, table){
		$(tbody).on("click", "button.eliminar", function(){
			...
			var idmarca = $("#frmEliminar #idmarca").val( data.idmarca );
		});
	}
	...
	var obtener_data_editar = function(tbody, table){
		$(tbody).on("click", "button.editar", function(){
			...
			var idmarca = $("#frmEditar #idmarca").val( data.idmarca );			
			var nombre_marca = $("#frmEditar #name").val(data.nombre_marca);
			var name_ingles = $("#frmEditar #name_ingles").val(data.nombre_marca_ingles);
		});
	}

	var eliminar = function(){
		$("#eliminar-marca").on("click", function(){
			var idmarca = $("#frmEliminar #idmarca").val();
			$.ajax({
				method:"POST",
				url: "../php/marca/removeData.php",
				data: {
						"idmarca": idmarca
					  }
			}).done( function( info ){
	...
	var editar = function(){
		$("#editar-marca").on("click", function(){
			...
			var nombre_marca = $("#frmEditar #name").val();
			var name_ingles = $("#frmEditar #name_ingles").val();

			$.ajax({
				method: "POST",
				url: "../php/marca/editData.php",
				data: {
					"idmarca"   : idmarca,
	...
	var guardar = function(){
		$("#agregar-marca").on("click", function(){
