...
$(window).on('load', function() {
    ...
    //listamos los datos...
	    ...
	    var t = $('#clientes_data').DataTable({
	        ...
	        "dom": '<"newtoolbar">frtip',
					...
					"ajax":{
						"method":"POST",
						"url": "../php/gremio/showData.php"
					},

					"columns":[
						{"data":"nombre_gremio"},
						{"data":"nombre_gremio_ingles"},						
						{"data":"created_gremio"},
						{"data":"modified_gremio"},						
	...
	var obtener_id_eliminar = function(tbody, table){
		$(tbody).on("click", "button.eliminar", function(){
			...
			var idgremio = $("#frmEliminar #idgremio").val( data.idgremio );
		});
	}
	...
	var obtener_data_editar = function(tbody, table){
		$(tbody).on("click", "button.editar", function(){
			...
			var idgremio = $("#frmEditar #idgremio").val( data.idgremio );
			var nombre_gremio = $("#frmEditar #name").val(data.nombre_gremio);
			var nombre_gremio = $("#frmEditar #name_ingles").val(data.nombre_gremio_ingles);
			
		});
	}

	var eliminar = function(){
		$("#eliminar-gremio").on("click", function(){
			var idgremio = $("#frmEliminar #idgremio").val();
			$.ajax({
				method:"POST",
				url: "../php/gremio/removeData.php",
				data: {
						"idgremio": idgremio
					  }
			}).done( function( info ){
	...
	var editar = function(){
		$("#editar-gremio").on("click", function(){

			var idgremio = $("#frmEditar #idgremio").val();
			var nombre_gremio = $("#frmEditar #name").val();
			var name_ingles = $("#frmEditar #name_ingles").val();

			$.ajax({
				method: "POST",
				url: "../php/gremio/editData.php",
				data: {
					"idgremio"   : idgremio,
					"name"   : nombre_gremio,
	...
	var guardar = function(){
		$("#agregar-gremio").on("click", function(){
